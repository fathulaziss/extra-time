package com.example.extratime.core.data
...
abstract class NetworkBoundResource<ResultType, RequestType>(private val mExecutors: AppExecutors) {
    ...
    protected abstract fun shouldRequestFromApi(data: ResultType?): Boolean

    protected abstract fun fetchFromApi(): LiveData<ApiResponse<RequestType>>

    protected abstract fun saveApiResult(data: RequestType)
